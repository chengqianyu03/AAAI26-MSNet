...
class SAMDataLoader(Dataset):
    def __init__(self,
        ...
        # NOTE 20260504: removed A.ColorJitter to match rms augmentation set.
        # rms (which reaches ~0.81 IoU) uses ONLY HFlip + Rotate + RandomScale + Resize.
        # ColorJitter perturbs the photometric statistics CLIP/SAM rely on and
        # can degrade IoU on glass/reflection segmentation.
        if is_train:
