"""
Module Zoo for SAM Prompt Generation Backbones

This module provides a central registry for all available prompt generation models
that can be used with the SAM (Segment Anything Model) architecture.
Each model generates sparse and dense prompts from multiple input images.
"""
